...
function SelectPortal({ ...props }: React.ComponentProps<typeof SelectPrimitive.Portal>) {
	...
	return <SelectPrimitive.Portal data-slot="select-portal" container={shadowRoot} {...props} />;
}
...
function SelectSeparator({
	...
	return (
		<SelectPrimitive.Separator
			...
			className={cn('bg-border pointer-events-none -mx-1 my-1 h-px', className as string)}
			{...props}
		/>
	);
}
...
function SelectScrollUpButton({
	...
	return (
		<SelectPrimitive.ScrollUpButton
			...
			className={cn('flex cursor-default items-center justify-center py-1', className as string)}
			{...props}
		>
